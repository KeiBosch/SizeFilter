...
from my_label import Labeled_Image, Labeled_Object
...
# 入力フォルダ指定
xml_file_path = r"C:\Users\Yosuke\Documents\20200402_VSI物体追跡技術\性能評価方法\20200707_VOC_Filter\xml_input\test\LG02191030_input02_01_00"

# 出力フォルダ指定
output_file_path = r"C:\Users\Yosuke\Documents\20200402_VSI物体追跡技術\性能評価方法\20200707_VOC_Filter\xml_output"
...
# 出力
out_filepath = os.path.join(output_file_path, os.path.basename(xml_file_path))
with open(out_filepath, mode='w') as f:
    f.write(label.get_label_str())
print(load_voc_labeled_image(xml_file_path))
